 ...
 */
public class OfficialShareHolder extends RecyclerView.ViewHolder {
    ...
    public OfficialShareHolder(View itemView) {
        super(itemView);
        ...
        layoutBaseShare= (RelativeLayout) itemView.findViewById(R.id.rl_baseShare);

 ...
 */
public class MonthPointRankFragmentPresenter extends BeamBasePresenter<MonthPointRankFragment> {
    ...
    public void refreshData(){
        ...
        UserDataManager.getInstance().monthPointRank(queryMap, new Subscriber<HttpResult<ArrayList<UserPoint>>>() {
            @Override
